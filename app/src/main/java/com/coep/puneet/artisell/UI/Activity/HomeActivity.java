...
public class HomeActivity extends BaseActivity
{
    ...
    protected void setupLayout()
    {
        ...
        Integer[] mNavIds = {R.drawable.home_view_product, R.drawable.home_add_product, R.drawable.home_convert_language, R.drawable.home_my_profile, R.drawable.home_other_artisans, R.drawable.home_event, R.drawable.bs_ic_more_light, R.drawable.bs_ic_more_light};
